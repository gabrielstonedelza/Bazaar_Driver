    ...
    return Scaffold(
        ...
        body: GetBuilder<OrderController>(builder: (controller) {
          return ListView.builder(
              itemCount: controller.allMyDeliveredOrders != null
                  ? controller.allMyDeliveredOrders.length
                  : 0,
              itemBuilder: (context, index) {
                items = controller.allMyDeliveredOrders[index];
                return Card(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  Text(items['get_ordered_username'],
                                  ...
                                  const Divider(
                                      height: 10, color: Colors.blueGrey),
                                  Text(items['get_item_size'].toString(),
                                      style: const TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 15)),
                                  const Divider(
                                      height: 10, color: Colors.blueGrey),
                                  Text(items['get_order_quantity'].toString(),
                                      style: const TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 15)),
                            ...
                            Expanded(
                              ...
                              child: Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Center(
                                  child: Text(items['get_order_status'],
                                      style: const TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 15)),
                                ),
